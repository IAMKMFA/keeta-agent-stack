...
const toneClasses: Record<StatusTone, string> = {
  ...
  info: 'border border-[rgba(20,117,152,0.3)] bg-[rgba(20,117,152,0.1)] text-[var(--keeta-accent-deep)]',
  success:
  ...
  accent: 'border border-[rgba(50,149,144,0.36)] bg-[var(--keeta-accent-soft)] text-[#225f5c]',
};
