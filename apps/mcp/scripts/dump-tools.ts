 ...
 *
 * Run: `pnpm --filter @keeta-agent-sdk/mcp docs:tools`
 */
...
const MODULE_HEADINGS: Record<string, string> = {
  ...
  'control-plane': 'Control Plane (Keeta Agent SDK API surface)',
};
...
lines.push('> Run `pnpm --filter @keeta-agent-sdk/mcp docs:tools` to regenerate.');
lines.push('');
lines.push(
